...
class ImageUtils {
  ...
  static Future<Map<String, dynamic>> _pickImageFrom({ImageSource source, CameraDevice cameraDevice}) async {
    ...
    try{
      ...
      switch(e?.code){
        case cameraAccessDenied:
          resource['message'] = 'Camera permission denied. You have to grant permission from system settings';
          break;
        case galleryAccessDenied:
          resource['message'] = 'Gellery permission denied. You have to grant permission from system settings';
          break;
      }
    }catch(e){
      resource = {
  ...
  static Future<Map<String, dynamic>> takePhoto({CameraDevice cameraDevice}) async =>
